...
class NgramCutterTest:TestCase(){
    @Test
    fun test1() {
        ...
        NgramCutter(1).cut(s).toList().also{println(it)}
        NgramCutter(2).cut(s).toList().also{println(it)}
        NgramCutter(3).cut(s).toList().also{println(it)}
        NgramCutter(4).cut(s).toList().also{println(it)}
    }
}
